...
function ParallaxText({ children, baseVelocity = 100 }: ParallaxProps) {
  ...
  return (
    <div className="parallax overflow-hidden whitespace-nowrap flex flex-nowrap">
      <motion.div className="scroller font-extrabold text-[64px] flex whitespace-nowrap flex-nowrap" style={{ x }}>
...
export default function TextMoving() {
  return (
    <section className="w-full h-[40vh] bg-yellow-200 pt-[80vh] pb-[80vh] relative">
