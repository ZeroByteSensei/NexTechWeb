            ...
            <div className="mx-auto max-w-[1340px] px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-24">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center lg:gap-16">
                    <div className="max-w-xl text-center sm:text-left ">
                        <h2 className="text-3xl font-bold tracking-tight text-[#8e92d5] sm:text-4xl">
                        ...
                        aria-label="Previous slide" id="keen-slider-previous-desktop" className="rounded-full border border-[#8e92d5] p-3 text-[#8e92d5] transition hover:bg-[#8e92d5] hover:text-white">
                            <svg
                        ...
                        <button onClick={(e: any) =>e.stopPropagation() || instanceRef.current?.next() }
                            ...
                            className="rounded-full border border-[#8e92d5] p-3 text-[#8e92d5] transition hover:bg-[#8e92d5] hover:text-white"
                        >
                            <svg
                            className="size-5"
                            fill="none"
                    ...
                    <div ref={sliderRef} id="keen-slider" className="keen-slider">
                        {data.testimonials.map((testimonial, index) => (
                            <div key={index} className="keen-slider__slide w-[50%]">
                                <blockquote className="flex h-full flex-col justify-between bg-[#8e92d5] bg-opacity-25 rounded-md p-6 shadow-sm sm:p-8 lg:p-12">
                                    <div>
                                        ...
                                        <div className="mt-4">
                                        <p className="text-2xl font-bold text-[#FBDC6D] sm:text-3xl">&quot;{testimonial.review}&quot;</p>

                                        <p className="mt-4 leading-relaxed text-slate-200">{testimonial.content}</p>
                                        </div>
                                    </div>
                ...
                <div className="mt-8 flex justify-center gap-4 lg:hidden">
                    <button onClick={(e: any) => e.stopPropagation() || instanceRef.current?.prev() }
                        aria-label="Previous slide" id="keen-slider-previous" className="rounded-full border border-[#8e92d5] p-4 text-[#8e92d5] transition hover:bg-[#8e92d5] hover:text-white">
                        <svg
                    ...
                    <button onClick={(e: any) =>e.stopPropagation() || instanceRef.current?.next() }
                        aria-label="Next slide" id="keen-slider-next" className="rounded-full border border-[#8e92d5] p-4 text-[#8e92d5] transition hover:bg-[#8e92d5] hover:text-white" >
                        <svg
                        className="h-5 w-5"
                        fill="none"
                        stroke="currentColor"
