        ...
        <div className="w-full bg-[#181818]">
            <div className="w-full px-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 w-full gap-x-4 gap-y-4 md:gap-y-12 mt-8 sm:mt-12 ">
                        <div className="col-span-1 sm:col-span-2 w-full rounded-md flex flex-col justify-center px-6">
                            <p className="text-[#FBDC6D] text-lg capitalize font-bold border-b-4 border-[#FBDC6D] pb-2 w-fit">who are we?</p>
                            <h1 className="text-[#8e92d5] mt-4">Transforming Brands,<br/> Empowering Success.</h1>
                        ...
                        <div className="col-span-1 sm:col-span-2 sm:order-3 w-full rounded-md px-6 flex flex-col justify-center">
                        <p className="text-[#FBDC6D] text-lg capitalize font-bold border-b-4 border-[#FBDC6D] pb-2 w-fit">And Our Mission?</p>
                            <h1 className="text-[#8e92d5] mt-4">Innovative Solutions,<br/>Measurable Growth.</h1>
