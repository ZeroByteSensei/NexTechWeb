...
const BlogCard = ({ data, blog_folder }: { data: Post, blog_folder:string }) => {
    return ( 
        <div className="relative group cursor-pointer rounded-md overflow-hidden duration-500 w-64 h-80 bg-[#8e92d5] p-4 hover:border hover:border-[#FBDC6D]">
            <div className="w-full h-full">
                ...
                <div className="absolute w-full left-0 p-5 -bottom-20 duration-500 group-hover:-translate-y-12 group-hover:opacity-80 group-hover:bg-[#FBDC6D]">
                    ...
                    <span className="text-lg font-bold text-[#1B1E49] group-hover:text-[#1B1E49]">{data.frontmatter.title}</span>
