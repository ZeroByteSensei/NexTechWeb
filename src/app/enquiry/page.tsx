            ...
            <div className="flex flex-wrap -mx-4 lg:justify-between">
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                  <div className="mb-12 max-w-[570px] lg:mb-0">
                    <SectionHeader primaryText="ENQUIRY" secondaryText="Let us connect" bgColor="bg-[#FBDC6D]" textColor="text-[#1B1E49]"/>
                    <p className="text-base text-[#1B1E49] leading-relaxed text-body-color mb-9 mt-4 md:mt-0">
                        Just a few steps. Submit the form and our team will review everything and reach out to you regarding the service you want and we will provide you with the best solution for your business.
                    </p>
              ...
              <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                  <div className="relative p-8 bg-transparent border border-[#1B1E49] rounded-lg shadow-lg sm:p-12">
                    ...
                    <iframe data-tally-src="https://tally.so/embed/mOANaR?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1" width="100%" height="284" title="Contact form"></iframe>
